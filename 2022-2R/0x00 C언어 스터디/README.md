...
> 스터디 강사 : 컴퓨터학과 21 노윤헌 <br>스터디 일시 : 월요일 8시~9시
...
강의는 매 주 1회 비대면으로 진행할 예정입니다. C언어의 기본적인 문법에 대해서 다룰 예정이기에 기본 문법을 연습해볼 수 있는 연습 문제를 제공할 예정이며, 알고리즘과 PS의 기본에 대해서도 다룰 예정입니다.
